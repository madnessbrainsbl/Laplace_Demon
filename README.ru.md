...
- **Embedded observer (light cone)** (Formula L, [cone.py](cone.py)) — учебная
  модель времени: сигнал идёт 1 клетку/шаг, а сбор наблюдений завершается до
  начала прогноза. При других сроках сбора и ответа результат меняется.
